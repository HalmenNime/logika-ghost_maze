...
trea = GameSprite("treasure.png", win_width - 120, win_height - 80, 0)

w1 = Wall(154, 205, 50, 100, 20, 430, 10)
w2 = Wall(154, 205, 50, 100, 480, 350, 10)
w3 = Wall(154, 205, 50, 100, 20, 10, 380)
w4 = Wall(154, 205, 50, 210, 120, 10, 360)
w5 = Wall(154, 205, 50, 220, 250, 270, 10)
...
while game:
    ...
    if finish != True:
        ...
        if sprite.collide_rect(hero, cyborg) or sprite.collide_rect(hero, w1) or sprite.collide_rect(hero, w2) or sprite.collide_rect(hero, w3) or sprite.collide_rect(hero, w4) or sprite.collide_rect(hero, w5):
           ...
           kick.play()
        if sprite.collide_rect(hero, trea):
           finish = True
